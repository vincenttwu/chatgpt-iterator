...
export class BackgroundMessageRouter {
  ...
  constructor(control: ControlPlaneServer, tabs: TabRuntimeServer, runs?: RunRuntimeServer, templates?: TemplateRuntimeServer, presets?: PresetRuntimeServer, queues?: QueueRuntimeServer, settings?: SettingsRuntimeServer, diagnostics?: DiagnosticsRuntimeServer, history?: HistoryRuntimeServer) {
    this.#control = control; this.#tabs = tabs; this.#runs = runs; this.#templates = templates; this.#presets = presets; this.#queues = queues; this.#settings = settings; this.#diagnostics = diagnostics; this.#history = history;
  }
